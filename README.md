...
We could say it fills the gap between browser-based testing tools like Selenium (slow) and Symfony's KernelTestCase, which doesn't go outside the app, although it's at the very edge (very fast).
